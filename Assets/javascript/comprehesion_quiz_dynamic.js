...
function bindCeEvents() {
  ...
  function askFinishConfirm() {
    var ask =
      typeof window.tcfQuizConfirm === "function"
        ? window.tcfQuizConfirm
        : typeof window.tcfConfirm === "function"
          ? window.tcfConfirm
          : function (o) {
              return Promise.resolve(window.confirm(o.message));
            };
  ...
  /* Capture : si un overlay mange le bubble, on rattrape le clic Terminer */
  document.addEventListener(
    ...
    function (e) {
      ...
      if (!quizStarted || !quizScreen || quizScreen.classList.contains("hidden")) return;
      if (btn.getAttribute("data-tcf-finishing") === "1") return;
      btn.setAttribute("data-tcf-finishing", "1");
      e.preventDefault();
      e.stopPropagation();
      askFinishConfirm().finally(function () {
