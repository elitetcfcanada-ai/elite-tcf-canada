...
<head>
    ...
    <link rel="stylesheet" href="Assets/css/comprehesion_Orale.css">
...
<div class="tcf-quiz-standalone-wrap">
    ...
    <div class="app-container" id="start-screen">
        <header class="app-header">
            <div class="logo-container">
                ...
                <p class="subtitle">Test de Connaissance du Français — Compréhension orale</p>
            </div>
        </header>
    ...
    <script src="Assets/javascript/comprehension_quiz_dynamic.js"></script>
</div>
</body>
</html>
