...
try {
    ...
    $stmt = $pdo->query("SELECT id, author_name, rating, is_published FROM testimonials LIMIT 5");
    $testimonials = $stmt->fetchAll(PDO::FETCH_ASSOC);
    echo "<h2>Exemples de témoignages corrigés</h2>";
    echo "<table border='1' style='border-collapse:collapse;'>";
    echo "<tr><th>ID</th><th>Auteur</th><th>Note</th><th>Publié</th></tr>";
