...
/**
 * Insère l'épreuve Expression écrite — Août 2025.
 * Usage: C:\xampp\php\php.exe scripts\seed_ee_aout_2025.php
 */
...
{
    $file = __DIR__ . '/../database/seeds/exp_ecrite/aout_2025_data.php';
    if (!is_file($file)) {
...
$slug = 'ee-expression-ecrite-aout-2025';
$title = 'Expression Écrite - Août 2025';
$subtitle = 'Sujets et corrections — Août 2025';
