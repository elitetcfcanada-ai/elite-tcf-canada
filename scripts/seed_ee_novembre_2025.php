...
/**
 * Insère l'épreuve Expression écrite — Novembre 2025.
 * Usage: C:\xampp\php\php.exe scripts/seed_ee_novembre_2025.php
 */
...
{
    $file = __DIR__ . '/../database/seeds/exp_ecrite/novembre_2025_data.php';
    if (!is_file($file)) {
...
$slug = 'ee-expression-ecrite-novembre-2025';
$title = 'Expression Écrite - Novembre 2025';
$subtitle = 'Sujets et corrections — Novembre 2025';
