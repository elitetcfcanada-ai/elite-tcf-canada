...
/**
 * Insère l'épreuve Expression écrite — Avril 2026.
 * Usage: C:\xampp\php\php.exe scripts/seed_ee_avril_2026.php
 */
...
{
    $file = __DIR__ . '/../database/seeds/exp_ecrite/avril_2026_data.php';
    if (!is_file($file)) {
...
$slug = 'ee-expression-ecrite-avril-2026';
$title = 'Expression Écrite - Avril 2026';
$subtitle = 'Sujets et corrections — Avril 2026';
