<?php
/**
 * Importe Compréhension Écrite 2 depuis database/seeds/ce_exam_2.json
 * Usage : php scripts/seed_ce_exam_2.php
 */
declare(strict_types=1);

require_once __DIR__ . '/../includes/config.php';

$jsonPath = __DIR__ . '/../database/seeds/ce_exam_2.json';
if (!is_file($jsonPath)) {
...
$title = trim((string) ($payload['title'] ?? 'Compréhension Écrite 2'));
$subtitle = trim((string) ($payload['subtitle'] ?? 'Épreuve de compréhension écrite — 39 questions'));
...
$slug = 'comprehension-ecrite-2-' . substr(uniqid('', true), -6);
