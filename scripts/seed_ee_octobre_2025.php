...
/**
 * Insère l'épreuve Expression écrite — Octobre 2025.
 * Usage: C:\xampp\php\php.exe scripts/seed_ee_octobre_2025.php
 */
...
{
    $file = __DIR__ . '/../database/seeds/exp_ecrite/octobre_2025_data.php';
    if (!is_file($file)) {
...
$slug = 'ee-expression-ecrite-octobre-2025';
$title = 'Expression Écrite - Octobre 2025';
$subtitle = 'Sujets et corrections — Octobre 2025';
