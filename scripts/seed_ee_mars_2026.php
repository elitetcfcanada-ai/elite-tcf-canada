...
/**
 * Insère l'épreuve Expression écrite — Mars 2026.
 * Usage: C:\xampp\php\php.exe scripts/seed_ee_mars_2026.php
 */
...
{
    $file = __DIR__ . '/../database/seeds/exp_ecrite/mars_2026_data.php';
    if (!is_file($file)) {
...
$slug = 'ee-expression-ecrite-mars-2026';
$title = 'Expression Écrite - Mars 2026';
$subtitle = 'Sujets et corrections — Mars 2026';
