...
/**
 * Insère l'épreuve Expression écrite — Février 2026.
 * Usage: C:\xampp\php\php.exe scripts/seed_ee_fevrier_2026.php
 */
...
{
    $file = __DIR__ . '/../database/seeds/exp_ecrite/fevrier_2026_data.php';
    if (!is_file($file)) {
...
$slug = 'ee-expression-ecrite-fevrier-2026';
$title = 'Expression Écrite - Février 2026';
$subtitle = 'Sujets et corrections — Février 2026';
