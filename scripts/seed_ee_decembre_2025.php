...
/**
 * Insère l'épreuve Expression écrite — Décembre 2025.
 * Usage: C:\xampp\php\php.exe scripts/seed_ee_decembre_2025.php
 */
...
{
    $file = __DIR__ . '/../database/seeds/exp_ecrite/decembre_2025_data.php';
    if (!is_file($file)) {
...
$slug = 'ee-expression-ecrite-decembre-2025';
$title = 'Expression Écrite - Décembre 2025';
$subtitle = 'Sujets et corrections — Décembre 2025';
