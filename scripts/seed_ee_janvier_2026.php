...
/**
 * Insère l'épreuve Expression écrite — Janvier 2026.
 * Usage: C:\xampp\php\php.exe scripts/seed_ee_janvier_2026.php
 */
...
{
    $file = __DIR__ . '/../database/seeds/exp_ecrite/janvier_2026_data.php';
    if (!is_file($file)) {
...
$slug = 'ee-expression-ecrite-janvier-2026';
$title = 'Expression Écrite - Janvier 2026';
$subtitle = 'Sujets et corrections — Janvier 2026';
