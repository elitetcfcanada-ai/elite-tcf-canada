# -*- coding: utf-8 -*-
"""Genere database/seeds/exp_orale/decembre_2025.json pour seed_eo_decembre_2025.php."""
import json
from pathlib import Path

from eo_dec_2025_t2 import TACHE2
from eo_dec_2025_t3 import TACHE3

ROOT = Path(__file__).resolve().parents[1]
OUT = ROOT / "database" / "seeds" / "exp_orale" / "decembre_2025.json"
